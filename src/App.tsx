        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-3">
            ...
            <p className="text-[10px] leading-relaxed text-slate-500">
              This portal conforms to standard digital service guidelines (NDSAP) of India. Hosted on secure block servers under the Visakhapatnam District Digital e-Governance Initiative (Vadlapudi & Kurmannapalem wards).
            </p>
